<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta eliminato l\'account, tutti i dati ad esso correlati verranno cancellati. Prima di procedere, scarica tutti i dati o le informazioni che vuoi recuperare.') }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="text-lg font-medium text-gray-900">
                        {{ __('Sei sicuro di voler eliminare questo account?') }}
                    </h2>
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Una volta eliminato l\'account, tutti i dati ad esso correlati verranno cancellati. Prima di procedere, scarica tutti i dati o le informazioni che vuoi recuperare.') }}
                    </p>
